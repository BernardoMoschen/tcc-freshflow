...
export function CartPreview() {
  ...
  return (
    <>
      ...
      >
        <ShoppingCart className="h-6 w-6" />
        <Badge className="absolute -top-1 -right-1 h-6 w-6 flex items-center justify-center rounded-full bg-red-500 text-white text-xs border-2 border-white">
          {count}
        </Badge>
      </button>
      ...
      {isOpen && (
        <>
          ...
          {/* Drawer */}
          <div className="fixed right-0 top-0 bottom-0 w-full max-w-md bg-white z-50 shadow-2xl animate-in slide-in-from-right duration-300 flex flex-col">
            {/* Header */}
